...
class Lang(models.Model):
    ...
    Clrs = models.CharField(max_length=200, default="Etc")
...
class Edu(models.Model):
    ...
    Degr = models.CharField(max_length=150, default="Degree")
    Durt = models.CharField(max_length=100, default="2020")
    Abut = models.TextField(max_length=500, default="Etc")
    Proj = models.ManyToManyField(Project, blank=True)
    Skls = models.ManyToManyField(Lang)
...
class Work(models.Model):
    Acct = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, default=1)
    Role = Comp = models.CharField(max_length=150, default="Janitor")
